...
require_relative 'simple_linked_list_2'
...
class LinkedListTest < Minitest::Test
  ...
  def test_from_a_2_element_array
    ...
    assert_equal 2, list.size, "size is not 2"
    assert_equal 1, list.peek, "head is not 1"
    assert_equal 2, list.head.next.datum, "next datum is not 2"
  end
